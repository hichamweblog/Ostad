    ...
    const wordHtml = `
      ...
      <body dir="rtl">
        <div class="WordSection1" dir="rtl">
          ...
          <p align="center" style="text-align: center; font-size: 12pt; font-weight: bold; text-decoration: underline; margin: 4px 0 6px 0;">
            ${docTitle}
          </p>
