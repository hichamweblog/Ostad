...
export const SidebarSanad: React.FC<SidebarSanadProps> = ({
  ...
  const isDuplicatedOnMobile = ['dashboard', 'classes', 'attendance', 'grades'].includes(item.id);
                ...
                return (
                  <button
                    ...
                    className={`w-full ${isDuplicatedOnMobile ? 'hidden lg:flex' : 'flex'} items-center gap-3 px-3 py-2.5 rounded-xl text-xs font-bold transition-all text-right cursor-pointer group relative ${
                      isActive
