          ...
          <div className="bg-white rounded-2xl max-w-md w-full p-6 shadow-xl border border-slate-200 text-right space-y-4">
            ...
            <form onSubmit={handleSaveSlot} className="space-y-4 text-xs">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="block font-bold text-slate-700 dark:text-slate-300 mb-1">من (البداية)</label>
                  <select
                ...
                <div>
                  <label className="block font-bold text-slate-700 dark:text-slate-300 mb-1">إلى (النهاية)</label>
                  <select
              ...
              {/* Class Selection */}
              <div>
                <label className="block font-bold text-slate-700 dark:text-slate-300 mb-1">الفوج التربوي</label>
                <select
              ...
              {/* Room Number */}
              <div>
                <label className="block font-bold text-slate-700 dark:text-slate-300 mb-1">القاعة</label>
                <input
                  type="text"
                  value={selectedRoom}
