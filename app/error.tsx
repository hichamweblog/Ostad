...
export default function Error({
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-[#F4F1EA]">
      <div className="text-center p-8 bg-white rounded-3xl border border-[#DDD7CB] shadow-md max-w-md w-full mx-4">
        <h1 className="text-3xl font-bold text-[#0D6547] mb-4">خطأ غير متوقع</h1>
        <p className="text-xl text-[#0F172A] mb-6">حدث خطأ أثناء معالجة طلبك.</p>
        <button 
          onClick={() => reset()}
